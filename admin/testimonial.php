                    ...
                    <?php $i=0; while($data=$testimonial->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="testimonial_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-danger btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
