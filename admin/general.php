...
if(isset($_POST['email'])){
    ...
    $query="update general_info set phone='$phone',email='$email',logo='$file',footer_logo='$footer_logo',address='$address',website='$website',map='$map'";
    $db->query($query);
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <span>
                      <img src="../assets/image/<?php echo $data['logo'] ?>" alt="" height="50" width="50">
                    </span>
                  </div>
                  <div class="form-group">
                  ...
                  <span>
                      <img src="../assets/image/<?php echo $data['footer_logo'] ?>" alt="" height="50" width="50">
                    </span>
                  </div>
