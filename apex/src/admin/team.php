...
if(isset($_POST['title'])){
    ...
    $query="INSERT INTO `team` (`id`, `photo`,`title`,`name`) VALUES (NULL, '$file', '$title','$name')";
    $db->query($query);
                    ...
                    <?php $i=0; while($data=$team->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="team_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-danger btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
