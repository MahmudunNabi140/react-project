...
if(isset($_POST['title'])){
    ...
    $query="INSERT INTO `icone` (`id`,`title`, `details`) VALUES (NULL,'$t_1', '$details')";
    $db->query($query);
                ...
                <table class="table table-bordered">
                    ...
                    <?php $i=0; while($data=$icone->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td>
                              <a href="icone_edit.php?id=<?php echo $data['id'] ?>" class="btn btn-success btn-xs">Edit</a>
                              <a href="icone_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-danger btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
